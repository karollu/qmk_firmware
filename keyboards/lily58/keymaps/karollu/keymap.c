...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  SC_LSPO, KC_Z   , __HRX__, KC_C   , KC_D   , KC_V,    KC_NO,   KC_MUTE, KC_K   , KC_H   , KC_COMM, KC_DOT , _HRSLA_, SC_RCPC,
                             GO_SPEC, GOMEDIA, GO__NAV, GOMOUSE,  GO__FUN, GO__NUM, KC_ALGR, GO__SYM
  ),
  ...
  SC_LSPO, KC_Z   , __HRX__, KC_C   , KC_V   , KC_B   ,   KC_NO,   KC_MUTE, KC_N   , KC_M   , KC_COMM, KC_DOT , _HRSLA_, _______,
                             KC_LALT, GOMEDIA, GO__NAV, GOMOUSE,  GO__FUN, GO__NUM, GO__SYM, KC_ALGR
  ),
  ...
  SC_LSPO, KC_Z   , __HRX__, KC_C   , KC_D   , KC_V,    KC_NO,   KC_MUTE, KC_K   , KC_H   , KC_COMM, KC_DOT , KC_SLSH, _______,
                             KC_LALT, KC_ESC , KC_TAB , KC_ENT , KC_BSPC, KC_SPC , KC_DEL , KC_ALGR
  ),
  ...
  KC_TAB,  _BOOT__, __TAP__, _EXTRA_, _BASE__, KC_NO,                        _COPY__, _UNDO__, _REDO__, __CUT__, _PASTE_, QK_AREP,
  ...
  [MOUSE] = LAYOUT(
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
  KC_TAB,  _BOOT__, __TAP__, _EXTRA_, _BASE__, KC_NO,                     _COPY__, _UNDO__, _REDO__, __CUT__, _PASTE_, _______,
  ...
  [MEDIA] = LAYOUT(
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
  KC_TAB,  _BOOT__, __TAP__, _EXTRA_, _BASE__, KC_NO,                     RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_TOG, _______,
  KC_ESC,  KC_LGUI, KC_LCTL, KC_LALT, KC_LSFT, XXXXXXX,                      XXXXXXX, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______,
  _______, _______, KC_ALGR, __SYM__, _MOUSE_, XXXXXXX,    KC_NO,   KC_MUTE, KC_MSTP, NK_TOGG, XXXXXXX, XXXXXXX, OU_AUTO, _______,
                             _______, _______, KC_SPC , KC_ENT,  KC_MPLY, KC_MUTE, XXXXXXX, XXXXXXX
  ),

  [FUN] = LAYOUT(
  KC_F13,  KC_F14,    KC_F15,    KC_F16,    KC_F17,    KC_F18,                      KC_F19,    KC_F20,    KC_F21,    KC_F22,    KC_F23,    KC_F24,
  KC_TAB,  KC_F12 , KC_F7  , KC_F8  , KC_F9  , KC_PSCR,                      _______, _BASE__, _EXTRA_, __TAP__, _BOOT__, _______,
  ...
  [NUM] = LAYOUT(
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
  KC_TAB,  KC_LBRC, KC_7   , KC_8   , KC_9   , KC_RBRC,                      _______, _BASE__, _EXTRA_, __TAP__, _BOOT__, _______,
  ...
  _______, KC_GRV,  KC_1   , KC_2   , KC_3   , KC_BSLS, KC_NO,   KC_MUTE, _______, __NUM__, __NAV__, KC_ALGR, _______, _______,
                             KC_LALT, KC_DOT , KC_0   , KC_MINS, _______, _______, _______, _______
  ),

  [SYM] = LAYOUT(
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
  KC_TAB,  KC_LCBR, KC_AMPR, KC_ASTR, KC_LPRN, KC_RCBR,                      _______, _BASE__, _EXTRA_, __TAP__, _BOOT__, _______,
  KC_ESC,  KC_DQUO, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS,                      _______, KC_RSFT, KC_ALGR, KC_RCTL, KC_RGUI, _______,
  _______, KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_PIPE,    KC_NO,   KC_MUTE, _______, __SYM__, _MOUSE_, KC_ALGR, _______, _______,
                             KC_LALT, KC_LPRN, KC_RPRN, KC_UNDS, _______, _______, _______, _______
  ),
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [SYM] =   ACTION_TAP_DANCE_SET_LAYER(SYM),
